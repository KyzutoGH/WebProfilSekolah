...
<div class="container col-xxl-8">
    ...
    <form action="{{ route('blog.update', $artikel->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group mb-4">
            ...
            <input type="date" class="form-control @error('tanggal_pelaksanaan') is-invalid @enderror" name="tanggal_pelaksanaan" value="{{ old('tanggal_pelaksanaan', $artikel->tanggal_pelaksanaan) }}">
