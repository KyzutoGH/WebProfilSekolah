    ...
    <p>
        <p>
            <p>
                <p>
    <p class="catatan">
        *Jika seluruh data pada formulir ini telah diisi dengan lengkap dan benar, mohon segera menyerahkan formulir ini kepada panitia PPDB pada waktu yang telah ditentukan. 
        Formulir yang sudah dikumpulkan akan digunakan sebagai bukti pendaftaran dan dapat ditukarkan dengan seragam olahraga gratis bagi calon peserta didik.*
    </p>
</body>
</html>
